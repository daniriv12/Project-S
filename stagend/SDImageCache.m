...
static SDImageCache2 *instance;

@implementation SDImageCache2
...
#pragma mark SDImageCache2 (class methods)

+ (SDImageCache2 *)sharedImageCache
{
    if (instance == nil)
    {
        instance = [[SDImageCache2 alloc] init];
    }

    return instance;
}

#pragma mark SDImageCache2 (private)
