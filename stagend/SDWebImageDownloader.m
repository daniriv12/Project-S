...
NSString *const SDWebImageDownloadStartNotification2 = @"SDWebImageDownloadStartNotification";
NSString *const SDWebImageDownloadStopNotification2 = @"SDWebImageDownloadStopNotification";

@interface SDWebImageDownloader2 ()
@property (nonatomic, retain) NSURLConnection *connection;
@end

@implementation SDWebImageDownloader2
    ...
    if (NSClassFromString(@"SDNetworkActivityIndicator"))
    {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:activityIndicator
                                                 selector:NSSelectorFromString(@"startActivity")
                                                     name:SDWebImageDownloadStartNotification2 object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:activityIndicator
                                                 selector:NSSelectorFromString(@"stopActivity")
                                                     name:SDWebImageDownloadStopNotification2 object:nil];
    }

    SDWebImageDownloader2 *downloader = [[[SDWebImageDownloader2 alloc] init] autorelease];
    downloader.url = url;
...
- (void)start
{
    ...
    if (connection)
    {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:SDWebImageDownloadStartNotification2 object:nil];
    }
    else
    {
...
- (void)cancel
{
    if (connection)
    {
        [connection cancel];
        self.connection = nil;
        [[NSNotificationCenter defaultCenter] postNotificationName:SDWebImageDownloadStopNotification2 object:nil];
    }
}
