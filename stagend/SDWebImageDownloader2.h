...
extern NSString *const SDWebImageDownloadStartNotification2;
extern NSString *const SDWebImageDownloadStopNotification2;

@interface SDWebImageDownloader2 : NSObject
{
    @private
    NSURL *url;
